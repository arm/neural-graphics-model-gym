...
from ng_model_gym.core.loss.losses import LossV0_1, LossV1, LPIPSSpatialLossV1
...
def get_loss_fn(params: ConfigModel, device: torch.device):
    ...
    if loss_name == LossFn.LOSS_V1:
        loss_args = params.train.loss_args or {}
        return LossV1(params.model.recurrent_samples, device, loss_args)
