...
class CLIIntegrationTest(NSSV1BaseIntegrationTest):
    ...
    def test_listing_models(self):
        ...
        self.assertIn("* nss_v1_0_1_high_fp32.pt", sub_process.stdout)
    ...
    def test_downloading_models(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertIn(
                "Downloaded neural-super-sampling/nss_v1_0_1_high_fp32.pt to",
                sub_process.stdout,
            )

            self.assertTrue((tmpdir / Path("nss_v1_0_1_high_fp32.pt")).exists())
