...
from ng_model_gym.core.export.model_export import ExportType
...
class TestExecuTorchIntegration(unittest.TestCase):
    ...
    def test_executorch_tosa_export_fp32(self):
        ...
        models = [
            "./tests/usecases/nss/weights/nss_v1_0_1_high_fp32.pt",
    ...
    def test_executorch_tosa_qat_int8_export(self):
        ...
        models = [
            "./tests/usecases/nss/weights/nss_v1_0_1_high_int8.pt",
            "@neural-super-sampling/nss_v1_0_1_high_int8.pt",
        ]
    ...
    def test_export_function_raises_error_missing_dataset_path(self):
        ...
        qat_model_path = "tests/usecases/nss/weights/nss_v1_0_1_high_int8.pt"

        fp32_model_path = "tests/usecases/nss/weights/nss_v1_0_1_high_fp32.pt"
