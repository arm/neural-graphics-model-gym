...
def normalise_tag(tag: str, params: dict) -> str:  # pylint: disable=unused-argument
    """
    Normalise the tag to be PEP-440 compliant for building the wheel
    Works with both 'upstream/v' and 'v' tags, plus optional end suffix,
    e.g. 'rc1' or '-rc1'
        v0.1.0          -> 0.1.0
        upstream/v0.1.0 -> 0.1.0
        v0.1.0rc1       -> 0.1.0rc1
        upstream/v0.1.0rc1 -> 0.1.0rc1
        v0.1.0-rc1      -> 0.1.0rc1
        upstream/v0.1.0-rc1 -> 0.1.0rc1
    """
    tag_matched = re.match(
        r"^(?:upstream/)?v(?P<base>[0-9]+(?:\.[0-9]+)*)"
